...
void AWarriorSurvivalGameMode::InitGame(const FString& MapName,
...
int32 AWarriorSurvivalGameMode::TrySpawnWaveEnemies()
{
    ...
    for (const FWarriorEnemyWaveSpawnerInfo& SpawnerInfo : GetCurrentWaveSpawnerTableRow()->EnemyWaveSpawnerDefinitions)
    {
        ...
        for (int32 i = 0; i < NumToSpawn; i++)
        {
            ...
            AWarriorEnemyCharacter* SpawnedEnemy = GetWorld()->SpawnActor<AWarriorEnemyCharacter>(LoadedEnemyClass,
                RandomLocation, SpawnRotation, SpawnParam);
